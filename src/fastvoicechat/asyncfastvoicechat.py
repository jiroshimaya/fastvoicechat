...
from fastvoicechat.asynclib.base import AsyncCallbackLoop
from fastvoicechat.asynclib.llm import AsyncLLM
from fastvoicechat.asynclib.stt import AsyncFastSTT
from fastvoicechat.asynclib.tts import AsyncTTS
...
class AsyncFastVoiceChat:
    ...
    def __init__(
        ...
        *,
        ...
        # 各コンポーネントの初期化
        self.faststt: AsyncFastSTT
        self.llm_backchannel: AsyncLLM
        self.llm_answer: AsyncLLM
        self.tts: AsyncTTS

        # 割り込み制御
        self.interrupt_event = asyncio.Event()
        self.interruption_observer: AsyncCallbackLoop
    ...
    async def initialize(self):
        ...
        self.faststt = AsyncFastSTT(stt_callback=stt_callback)
        ...
        self.tts = AsyncTTS(speaker=self.speaker, voicevox_host=self.voicevox_host)
